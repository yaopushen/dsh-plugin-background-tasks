...
export function registerBackgroundTools(ctx, manager, config) {
    ...
    disposers.push(ctx.tools.register(defineTool({
        ...
        description: 'Run a shell command (PowerShell on Windows via -EncodedCommand, Bash on Linux/macOS). ' +
    ...
    disposers.push(ctx.tools.register(defineTool({
        ...
        description: 'Manage background tasks started by run_background_command: list them, inspect status or live logs, or terminate a running task tree.',
        parameters: {
            action: {
                type: 'string',
