...
const DIALECT_GUIDANCE = [
  ...
  'wait_ms is patience before yielding, not a runtime cap: the command finishes either way and results arrive either way, so keep the default unless the very next step truly depends on this result inline.',
